package com.example.moodlegovapp

import com.example.moodlegovapp.core.app.AppAssembly
...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var assembly: AppAssembly

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        assembly = AppAssembly.getInstance(this)
...
@Composable
fun AppRoot(assembly: AppAssembly) {
...
@Composable
fun MainTabView(assembly: AppAssembly) {
            ...
            NavigationBar(
                ...
                Tab.all.forEach { tab ->
                    ...
                    NavigationBarItem(
                        ...
                        label     = { Text(stringResource(tab.labelRes), style = com.example.moodlegovapp.ui.theme.SpTypography.small()) },
...
private fun PlaceholderScreen(label: String) {
    Surface(modifier = Modifier.fillMaxSize(), color = SpColors.LightGray) {
        androidx.compose.foundation.layout.Box(
            ...
            Text(label, style = com.example.moodlegovapp.ui.theme.SpTypography.headingL(), color = SpColors.DarkBrown)
        }
    }
}
