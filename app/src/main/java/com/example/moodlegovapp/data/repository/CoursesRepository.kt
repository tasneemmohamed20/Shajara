...
class CoursesRepository(
    ...
    override suspend fun getCourseResources(courseId: Int): AppResult<List<com.example.moodlegovapp.domain.models.MoodleResource>> = api.getCourseResources(courseId)
    override suspend fun getAssignments(courseId: Int): AppResult<List<MoodleAssignment>> = api.getAssignments(courseId)
    override suspend fun getAssignmentDetail(assignmentId: Int): AppResult<MoodleAssignment> = api.getAssignmentDetail(assignmentId)
